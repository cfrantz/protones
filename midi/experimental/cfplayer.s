...
.proc play_music_channel
    ...
    bmi     done                    ; negative - still delaying.
load_sequence_pos:
...
note_off_event:
note_event:
    jsr     play_note               ; play the note
    beq     load_music_event        ; expect zero flag to be set after play_note
unknown_event:
done:
    jsr     process_envelope
    rts
.endproc
